...
module.exports = function csrf(options) {
  ...
  return function(req, res, next){
    ...
    console.log("start secret is %s", secret);
    ...
    uid(24, function(err, secret){
      ...
      console.log("create secret is %s", secret);
      createToken(secret);
    });
    ...
    function createToken(secret) {
      ...
      req.csrfToken = function csrfToken() {
        console.log("now token is %s", token);
        var t = token || (token = saltedToken(secret));
        console.log("gen csrf token, url %s, secret %s, token %s", req.url, secret, t);
        return  t;
      };
